...
# boston = load_boston()
# print(boston.DESCR)
# boston_df = pd.DataFrame(boston.dataset, columns=boston.feature_names)
...
# sns.regplot(x="LSTAT", y="MEDV", dataset=boston_df)
# pyplot.show()
#
...
#
# results = smf.ols('MEDV ~ LSTAT', dataset=boston_df).fit()
